...
fun StatisticsScreen(
    ...
    Scaffold(
        ...
        StatisticsContent(
            uiState = uiState,
            dateEventMap = uiState.dateEventMap,
            onSearchQueryChange = { viewModel.onSearchQueryChange(it) },
            onCalendarDateRangeChange = { startDate, endDate ->
                viewModel.onCalendarDateRangeChange(startDate, endDate)
            },
...
fun StatisticsContent(
    ...
    onCalendarDateRangeChange: (LocalDate, LocalDate) -> Unit,
    navigateToEdit: (Int) -> Unit,
    modifier: Modifier = Modifier,
    ...
    Column(
        ...
        key(uiState.searchQuery) {
            ScrollableEventCalendar(
                ...
                onDateRangeChange = onCalendarDateRangeChange,
                oldestDate = uiState.oldestEventDate,
